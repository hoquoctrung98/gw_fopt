...
fig.savefig(f"./figures/evolution_gradient_energy_density.png", bbox_inches="tight", facecolor="white")
fig.set_size_inches(6, 3)

fig, ax = analyzer.plot_surface_tension(small_s_range=(4e-1, 6e-1), large_s_range=(2.12, 4), normalized=True)
