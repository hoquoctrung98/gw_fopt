// TODO:
// Here we plan to use segment utils to decompose the first bubbles into segment
// corresponding to the same bubble, hence potentially increase the performance.
