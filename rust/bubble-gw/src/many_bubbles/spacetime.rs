//! This module is part of the nalgebra_spacetime crate
//! https://github.com/qu1x/nalgebra-spacetime/blob/main/src/lib.rs
//! All credits goes to the author of nalgebra_spacetime
//! The reason I include this file instead of using Cargo.toml is to solve dependency issue
//! temporarily
...
use nalgebra::storage::{Owned, RawStorage, RawStorageMut, Storage, StorageMut};
use nalgebra::{
    DefaultAllocator,
    Dim,
    DimName,
    ...
    C: DimName,
{
    ...
    #[must_use]
    fn split(&self) -> (&T, MatrixView<'_, T, DimNameDiff<R, U1>, C, U1, R>)
    where
        R: DimNameSub<U1>,
        ShapeConstraint: DimEq<U1, C>,
    ...
    /// ```
    fn split_mut(&mut self) -> (&mut T, MatrixViewMut<'_, T, DimNameDiff<R, U1>, C>)
    where
        R: DimNameSub<U1>,
        ShapeConstraint: DimEq<U1, C>,
        DefaultAllocator: Allocator<R, C>,
    ...
    /// Spatial components.
    #[must_use]
    fn spatial(&self) -> MatrixView<'_, T, DimNameDiff<R, U1>, C, U1, R>
    where
        R: DimNameSub<U1>,
        ShapeConstraint: DimEq<U1, C>,
        DefaultAllocator: Allocator<R, C>,
    ...
    fn spatial_mut(&mut self) -> MatrixViewMut<'_, T, DimNameDiff<R, U1>, C, U1, R>
    where
        R: DimNameSub<U1>,
        ShapeConstraint: DimEq<U1, C>,
        DefaultAllocator: Allocator<R, C>,
    ...
    DefaultAllocator: Allocator<D>,
{
    ...
    #[must_use]
    #[inline]
    pub fn momentum(&self) -> VectorView<'_, T, DimNameDiff<D, U1>, U1, D>
    where
